function changeMap(response, i) {
    ...
    gMap.src = `https://www.google.com/maps/embed/v1/place?q=${location_adr}&key=<key>`;
    gMap2.src = `https://www.google.com/maps/embed/v1/directions?origin=place_id:ChIJRVcadg0W2jERQLUnN_6QBCw&destination=${location_adr}&key=<key>`
    gMap3.src = `https://www.google.com/maps/embed/v1/streetview?location=${location_lat}%2C${location_lng}&key=<key>`
}
